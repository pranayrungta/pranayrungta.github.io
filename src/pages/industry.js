...
export default function industry() {
    ...
    <div className="exp"><h4>Data Scientist at GE Healthcare</h4>
        ...
        <p className='just'> <ul>
            ...
            <p className='just'> Techniques used: TF-IDF, logistic regression, principal component analysis, collaborative filtering, singular value decomposition, k-means clustering, decision tree, logistic regression, fuzzy logic, Reliability analysis
            </p>
        </p>
    </div>
    <div className="exp"><h4>Data Scientist at dishq</h4>
        ...
        <p className='just'> Built ML model to classify recipe text into different attributes.
